...
func (k *Keeper) BroadcastSignedRawTransaction() {
	...
	//returns {"action":"broadcast","reqid":"3221212f","result":true,"message":"Tx data broadcast success: d322b30b3702ba76c9e83bfe0d92f92bdb531713c8846adf0cfb347a39c0fa1c","txs":[]}
	k.WriteJSON(msg)
}
